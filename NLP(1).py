...
#Training data : product review
reviews=[
    ('This product is absolutly amazing! Highly recomended!',1),
    ...
    ('Super satisfied with this purches!',1),
    ('Five stars! Outstandinng product!',1),
    ('Terrible quality.Broke after 2 days.',0),
    ('Worst purches ever complete waste of money!',0),
    ('Very disapponited.Not as described at all',0),
    ('Horrible experiance.never buying again',0),
...
#test on new data
new=[
    'This is wonderful product! Tottaly worth it!',
