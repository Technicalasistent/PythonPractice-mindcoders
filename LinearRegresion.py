...
print(f'Slope: {model.coef_[0]:.2f}mark increase per study hours')
print(f'Intercept:{model.intercept_:.2f} marks at 0 study')
...
print(f'Student studying 7 hours predict marks:{new_pred:.1f}')
...
plt.title('Linear Regresion-Study Hours vs Marks')
plt.legend()
